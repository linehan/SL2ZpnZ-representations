...
This is a Python SAGE software library to compute a complete set of exact representations of the finite group SL_2(Z/p^nZ), for choice of prime *p>2* and integer *n >= 2*.
